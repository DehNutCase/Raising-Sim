...
func display_stats():
	text = "[table=2][cell padding=32,0,32,0]New Game Bonus Stats:[/cell][cell padding=32,0,32,0][/cell][cell padding=32,0,32,0][/cell][cell padding=32,0,32,0][/cell][cell padding=32,0,32,0][/cell][cell padding=32,0,32,0][/cell]"
